...
class Resnet18Dropout(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.dropout_2_1 = nn.Dropout(0.5)
        ...
        self.dropout_2_2  = nn.Dropout(0.5)
        ...
        self.dropout_3_1 = nn.Dropout(0.5)
        self.indentity_shortcut_3 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=1, stride=2, padding=0)
        ...
        self.dropout_3_2 = nn.Dropout(0.5)
        ...
        self.dropout_4_1 = nn.Dropout(0.5)
        self.indentity_shortcut_4 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=1, stride=2, padding=0)
        ...
        self.dropout_4_2 = nn.Dropout(0.5)
        ...
        self.dropout_5_1 = nn.Dropout(0.5)
        self.indentity_shortcut_5 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=1, stride=2, padding=0)
        ...
        self.dropout_5_2 = nn.Dropout(0.5)
    ...
    def forward(self, x):
        ...
        x_2 = self.dropout_2_1(x_2)
        x_2_i = F.relu(x_2 + x_1)   # Adding identity (residual connection)

        x_2 = self.bn_2_3(self.conv_2_3(x_2_i))
        x_2 = F.relu(x_2)
        x_2 = self.bn_2_4(self.conv_2_4(x_2))
        x_2 = self.dropout_2_2(x_2)
        x_2 = F.relu(x_2 + x_2_i)   # Adding identity (residual connection)

        # Block 3
        x_3 = self.bn_3_1(self.conv_3_1(x_2))
        x_3 = F.relu(x_3)
        x_3 = self.bn_3_2(self.conv_3_2(x_3))
        x_3 = self.dropout_3_1(x_3)
        x_3_i = self.indentity_shortcut_3(x_2)   # Change the dimention of x_2
        x_3_i = F.relu(x_3 + x_3_i)  # Adding identity (residual connection)

        x_3 = self.bn_3_3(self.conv_3_3(x_3_i))
        x_3 = F.relu(x_3)
        x_3 = self.bn_3_4(self.conv_3_4(x_3))
        x_3 = self.dropout_3_2(x_3)
        x_3 = F.relu(x_3 + x_3_i)   # Adding identity (residual connection)

        # Block 4
        x_4 = self.bn_4_1(self.conv_4_1(x_3))
        x_4 = F.relu(x_4)
        x_4 = self.bn_4_2(self.conv_4_2(x_4))
        x_4 = self.dropout_4_1(x_4)
        x_4_i = self.indentity_shortcut_4(x_3)  # Change the dimention of x_3
        x_4_i = F.relu(x_4 + x_4_i)   # Adding identity (residual connection)

        x_4 = self.bn_4_3(self.conv_4_3(x_4_i))
        x_4 = F.relu(x_4)
        x_4 = self.bn_4_4(self.conv_4_4(x_4))
        x_3 = self.dropout_4_2(x_3)
        x_4 = F.relu(x_4 + x_4_i)     # Adding identity (residual connection)

        # Block 5
        x_5 = self.bn_5_1(self.conv_5_1(x_4))
        x_5 = F.relu(x_5)
        x_5 = self.bn_5_2(self.conv_5_2(x_5))
        x_5 = self.dropout_5_1(x_5)
        x_5_i = self.indentity_shortcut_5(x_4)  # Change the dimention of x_4
        x_5_i = F.relu(x_5 + x_5_i)   # Adding identity (residual connection)

        x_5 = self.bn_5_3(self.conv_5_3(x_5_i))
        x_5 = F.relu(x_5)
        x_5 = self.bn_5_4(self.conv_5_4(x_5))
        x_5 = self.dropout_5_2(x_5)
        x_5 = F.relu(x_5 + x_5_i)    # Adding identity (residual connection)
